...
layui.use(['form','table','layer'],function () {
    ...
    pageData.submitAddRole = function(name,seg,remark){
        ...
        common.sendOption.url = common.url.web_root + common.url.model.role.action + common.url.opt.add;
    ...
    pageData.deleteRole = function(obj){
        ...
        common.sendOption.url = common.url.web_root + common.url.model.role.action + common.url.opt.delete;
