...
layui.use(['form','layer','table','util'],function () {
    ...
    var exportTableHeader = [[
        ...
        {field: 'exportAccountName',title: '转出账户', align:'center',width:200,templet:'#exportAccountTemplate'},
        // {field: 'importAccountId',title: '转入账户', align:'center',width:150},
        {field: 'importAccountName',title: '转入账户', align:'center',width:200,templet:'#importAccountTemplate'},
